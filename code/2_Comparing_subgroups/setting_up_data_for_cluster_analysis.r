...
# reordering based on highest to lowerest impairment (determined after cluster comparisons)
...
# importing additional social communication data
...
# keeping only data for participants included in the study
...
# organizing IQ measures from different scales
...
# reorganizing measures into stacks to make certain analyses easier
top_measures <- all %>%
